    ...
    RSpec.describe HaversineDistance do
      ...
      describe '#calculate' do
        ...
        context 'when unit is "miles"' do
          ...
          it 'returns the distnace between the locations in miles' do
        ...
        context 'when the unit is "feet"' do
          ...
          it 'returns the distnace between the locations in feet' do
        ...
        context 'when the unit is "meters"' do
          ...
          it 'returns the distnace between the locations in meters' do
